...
![image-20220317164323216](webpack核心基础知识/image-20220317164323216.png)
...
![image-20220317165839570](webpack核心基础知识/image-20220317165839570.png)
...
![image-20220222160601799](webpack核心基础知识/image-20220222160601799.png)
...
![image-20220406071704272](webpack核心基础知识/image-20220406071704272.png)
...
![image-20220321070232800](webpack核心基础知识/image-20220321070232800.png)
...
![image-20220321070757944](webpack核心基础知识/image-20220321070757944.png)
...
![image-20220324071832160](webpack核心基础知识/image-20220324071832160.png)
...
![image-20220325065251536](webpack核心基础知识/image-20220325065251536.png)

新建`index.html`并引入js文件，可以看到样式已经生效了。

![image-20220325065501603](webpack核心基础知识/image-20220325065501603.png)
...
![image-20220325070825102](webpack核心基础知识/image-20220325070825102.png)
...
![image-20220325071546871](webpack核心基础知识/image-20220325071546871.png)
...
![image-20220328065112315](webpack核心基础知识/image-20220328065112315.png)
...
![image-20220328065727975](webpack核心基础知识/image-20220328065727975.png)
...
![image-20220406065006227](webpack核心基础知识/image-20220406065006227.png)
...
![image-20220406065204589](webpack核心基础知识/image-20220406065204589.png)

![image-20220406065211094](webpack核心基础知识/image-20220406065211094.png)
...
![image-20220406070304508](webpack核心基础知识/image-20220406070304508.png)
...
![image-20220419062922005](webpack核心基础知识/image-20220419062922005.png)
...
![image-20220421153752507](webpack核心基础知识/image-20220421153752507.png)
...
![image-20220421184839164](webpack核心基础知识/image-20220421184839164.png)
...
![image-20220421190421353](webpack核心基础知识/image-20220421190421353.png)



验证只在内存中编译，我们删掉`build`目录重新启动，目录如下：

![image-20220421190607972](webpack核心基础知识/image-20220421190607972.png)

仍可正常运行。

备注：如果有如下警告信息：

![image-20220421191053066](webpack核心基础知识/image-20220421191053066.png)
...
![image-20220421191329811](webpack核心基础知识/image-20220421191329811.png)

#### 开发环境基本配置

项目目录

![image-20220504134224810](webpack核心基础知识/image-20220504134224810.png)
...
![image-20220504134647159](webpack核心基础知识/image-20220504134647159.png)
...
![image-20220504134853785](webpack核心基础知识/image-20220504134853785.png)
...
![image-20220504135218696](webpack核心基础知识/image-20220504135218696.png)
...
![image-20220504203203060](webpack核心基础知识/image-20220504203203060.png)
...
![image-20220504203905558](webpack核心基础知识/image-20220504203905558.png)
...
![image-20220504204358659](webpack核心基础知识/image-20220504204358659.png)
...
![image-20220504215623408](webpack核心基础知识/image-20220504215623408.png)

启用压缩：

![image-20220504215754866](webpack核心基础知识/image-20220504215754866.png)

`css`体积减少了35%

![image-20220504215853809](webpack核心基础知识/image-20220504215853809.png)
...
![image-20220505071753088](webpack核心基础知识/image-20220505071753088.png)
...
![image-20220505072407868](webpack核心基础知识/image-20220505072407868.png)

但仍提示了一个`警告`：

![image-20220505072335426](webpack核心基础知识/image-20220505072335426.png)
...
![image-20220505144226925](webpack核心基础知识/image-20220505144226925.png)
...
![image-20220505151943532](webpack核心基础知识/image-20220505151943532.png)
...
![image-20220505153012005](webpack核心基础知识/image-20220505153012005.png)
...
![image-20220505153336502](webpack核心基础知识/image-20220505153336502.png)
...
![image-20220505161837963](webpack核心基础知识/image-20220505161837963.png)
...
![image-20220505162036838](webpack核心基础知识/image-20220505162036838.png)
...
![image-20220505164813899](webpack核心基础知识/image-20220505164813899.png)

压缩后大小：

![image-20220505164924620](webpack核心基础知识/image-20220505164924620.png)
...
![image-20220512150648685](webpack核心基础知识/image-20220512150648685.png)

![image-20220512150711600](webpack核心基础知识/image-20220512150711600.png)

修改可以生效的样式文件后：

![image-20220512151005219](webpack核心基础知识/image-20220512151005219.png)

![image-20220512151031062](webpack核心基础知识/image-20220512151031062.png)
...
- `HMR`：`hot module replacement`，热模块替换
  ...
  - 配置`HMR`后，再次更新的效果如下：
    ...
    ![image-20220512151419873](webpack核心基础知识/image-20220512151419873.png)
    ...
    - `js`文件：默认不能使用`HMR`功能
      ...
      - 解决方案：
        ...
        - 更改`print.js`后的效果：
          ...
          ![image-20220512154014176](webpack核心基础知识/image-20220512154014176.png)
...
- 配置文件最外层新增：`devtool: 'source-map'`
  ...
  - 执行`webpack`后，打包后的`build/js`目录下，会新增一个`.map`文件：
    ...
    ![image-20220512154906655](webpack核心基础知识/image-20220512154906655.png)
